...
* remove folder theme/boost_nead/scss/bootstrap
* copy the scss files from ~/bootstrap/scss to theme/boost_nead/scss/bootstrap
...
* comment out this line in theme/boost_nead/scss/_print.scss
    @page {
...
* remove folder theme/boost_nead/amd/src/bootstrap
* copy the js files from ~/bootstrap/js/src to theme/boost_nead/amd/src/bootstrap (including the subfolder)
* copy index.js from ~/bootstrap/js to theme/boost_nead/amd/src
* edit theme/boost_nead/amd/src/index.js and update import path (src -> bootstrap)
